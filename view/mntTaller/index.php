...
<html lang="es">
  <head>
    ...
    <title>Mantenimiento de Taller</title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>TALLERES 2024<span>]</span></a></div>
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="../MntProducto/" class="nav-link">Taller</a></li>
        </ul>
      </div>

      <label class="sidebar-label pd-x-15 mg-t-25 mg-b-20 tx-info op-9">Información importante</label>
